...
namespace ezcontrast
{
    partial class Form2
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label2.Text = "How to use: Pick 2 colors using the corresponding buttons on the left, and hover " +
    "the cursor over the color. You can increase the delay to make it easier to pick " +
    "the color.";
            // 
            // button1
            // 
            ...
            this.button3.Text = "Known issues";
            ...
            this.label1.Text = "Version 1.0 © jakubiakdev 2022";
